...
class Config:
    ...
    @property
    def collection_exp_step(self) -> str:
        """openBIS collection name for experimental steps."""
        return self.get("openbis.collection_exp_step", "UVSHEET_EXP_STEP")

    @property
    def collection_samples(self) -> str:
        """openBIS collection name for samples."""
        return self.get("openbis.collection_samples", "UVSHEET")
    ...
    def object_properties(self) -> Dict[str, Any]:
        """Get properties for object creation."""
